...
if num_density_des==4
    ...
    subplot(2,2,2);
    contour(X,Y,PDFj2,linspace(0.006,0.218,100),'linewidth',2)
    hold on;
    set(gcf,'color',[1 1 1]);
    xlabel('x')
    ylabel('y')
    ...
    plot(xdes(1,4),xdes(2,4),'xk','LineWidth',2)
    %plot individual points
    plot(squeeze(points_sim(1,2,:)),squeeze(points_sim(2,2,:)),'.r')
    hold off;
    
    subplot(2,2,3);
    contour(X,Y,PDFj4,linspace(0.006,0.218,100),'linewidth',2)
    hold on;
    set(gcf,'color',[1 1 1]);
    xlabel('x')
    ylabel('y')
    ...
    plot(xdes(1,4),xdes(2,4),'xk','LineWidth',2)
    %plot individual points
    plot(squeeze(points_sim(1,4,:)),squeeze(points_sim(2,4,:)),'.r');
    hold off;
    ...
    colorbar('Position', [hp4(1)+hp4(3)+0.01  hp4(2)+.015  0.03  hp4(2)+hp4(3)*2.1-.02])
end
